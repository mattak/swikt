...
export function createExpressionByPrimaryExpression(
  primaryExpression: TObject,
): TObject {
  return createTObject([
    "expression",
    "disjunction",
...
export function createPrimaryExpression_LiteralConstant(
  value: string,
): TObject {
  return createTObject(["primaryExpression", "literalConstant"], [value]);
}

export function createPrimaryExpression_lineStringContent(
  value: string,
): TObject {
